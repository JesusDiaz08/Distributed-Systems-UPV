...
public class DifusionJMS implements javax.jms.MessageListener, Difusion {
    ...
    //
    public DifusionJMS(IPYPortD ipyport, boolean yes) {
    	this(ipyport.ip,ipyport.port, yes);
    }
	public DifusionJMS(String ip, int port, boolean yes) {
        ...
        try {
            ...
            subscriber = (TopicSubscriber) sessionSuscriber.createSubscriber(dest);/***/
            ...
            publisher = (TopicPublisher) sessionPublisher.createPublisher(dest);/***/
	...
	public synchronized void onMessage(Message msg) {
		...
		try {
			...
			e.printStackTrace();
			System.out.println("Ha sido null a la hora de extraer"); // Ver metodo @receiveObject
		} /***/
		currentItem = obj;
